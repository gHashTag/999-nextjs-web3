      ...
      {showNote && isMobile ? (
        ...
        >
          ...
          <Dialog.Content className="dialog-content dialog-animation md:w-[300px] w-[95%] bg-[#111]   rounded-xl">
            ...
            <p>
              You cannot join the stage on mobile. Please join the session via a desktop/laptop and ask the speaker for
              another invite.{' '}
            </p>
  ...
  return (
    <div className="flex space-x-8">
      <div className="w-[300px] h-[300px] relative flex justify-center items-center bg-gray-700 rounded-lg">
        {isVideoOn ? (
          <video className="w-full h-full rounded-lg object-cover mirror" ref={videoRef} autoPlay muted playsInline />
        ) : (
      ...
      <div className="w-[320px] flex flex-col ml-8 justify-between">
        ...
        <form onSubmit={() => {}}>
          <p className="flex items-center space-x-1">
            <InfoIcon /> Note: Your mic is {isAudioOn ? 'on' : 'off'} and video is {isVideoOn ? 'on' : 'off'}
          </p>
