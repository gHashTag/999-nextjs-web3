          ...
          !stage.isLive ? (
            <div className={cn(styles.stream, styleUtils.appear, styleUtils['appear-first'])}>
              ...
              <div className={cn(styles.bottom, styleUtils.appear, styleUtils['appear-second'])}>
                ...
                <Link href={updatedStage.discord} target="_blank" rel="noopener noreferrer" className={styles.button}>
            ...
            <Room backstagePeers={stage.backstagePeers} stagePeers={stage.stagePeers} roomId={stage.roomId} />
          )
