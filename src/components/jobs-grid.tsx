...
function CompanyJobs({ jobs }: Props) {
  return (
    <div className={styles.grid}>
      {jobs.map((job) => (
        <Link key={job.id} className={styles.card} href={job.link} target="_blank" rel="noopener noreferrer">
        ...
        <div key={companyName} className={styles.companyRow}>
          <div className={styles.rowHeader}>
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 245 240" fill="white">
